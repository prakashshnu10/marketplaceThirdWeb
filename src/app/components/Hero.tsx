      ...
      <div className="w-full">
        <div className="relative z-10 grid lg:grid-cols-2 lg:items-center">
          <div className="pl-[50px] pr-[50px] py-16 space-y-6 sm:pl-[60px] lg:pl-[80px]">
            <h1 className="text-4xl  tracking-tighter sm:text-5xl xl:text-6xl/none">
              Tradible
            </h1>
            <p className="max-w-[600px] text-lg text-zinc-300 sm:text-xl ">
              Tradible: NFTs
            </p>
            <Link href="/shop">
              <button className="inline-flex items-center px-6 py-3 mt-4 text-lg  bg-blue-600 hover:bg-blue-700 rounded-md">
                Go to the Markerplace
